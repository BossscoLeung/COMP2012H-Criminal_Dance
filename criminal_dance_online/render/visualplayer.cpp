...
void VisualPlayer::setIsFirstPlayer(bool k)
{
    is_first_player = k;
}
...
bool VisualPlayer::getIsFirstPlayer()
{
    return is_first_player;
}

void VisualPlayer::mousePressEvent(QGraphicsSceneMouseEvent *event)
{

}
void VisualPlayer::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
